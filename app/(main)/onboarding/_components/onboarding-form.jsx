        ...
        <CardContent>
          <form className='space-y-6' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              ...
              <Input id="experience" type="number" min="0" max="50" placeholder="Years of Experience" {...register("experience")} />
              {errors.experience && (
            ...
            <div className="space-y-2">
              ...
              <Input id="experience"placeholder="e.g., Python, JavaScript, Project Management" {...register("skills")} />
